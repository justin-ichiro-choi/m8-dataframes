...
husky.games.2015 <- read.csv("file:///C:/Users/Justin/Documents/info201/m8-dataframes/exercise-7/data/huskies_2015.csv")
print(husky.games.2015)
# Create a vector of the teams that the Huskies played against during that season
# Call this vector `not.huskies`. You'll need to convert this column to a vector

not.huskies <- as.character(husky.games.2015$opponent)
...
maxYards <- as.integer(max(combined.yards))
